...
4. ✔️ построить дисперсионную кривую

(объяснить, причем тут дисперсия)

5. ✔️ построить зависимость $\phi(\nu)$ (с нанесением точек)

### Исследование резонансов:
(почему вообще сложение двух бегущих волн может дать стоячую)

6. ✔️ определить резонансные частоты и сравнить с теорией (те самые формулы для $Z_k = 0$ и $Z_k = \infty$)
7. ✔️ построить резонансную кривую по 3 точкам (для $Z_k = 0$ и $Z_k = \infty$)
8. ✔️ определить добротность (для $Z_k = 0$ и $Z_k = \infty$)

### Исследование запредельных колебаний:
9. ✔️ построить график распределения напряжений
10. ✔️ определить декремент затухания и сравнить с теорией
